...
/**
 * Unit categories corresponding to SI-based measurement systems.
 * Conversion uses factors relative to the SI base unit for each category.
 */
...
data class MeasurementUnit(
    val name: String,
    val symbol: String,
    val toBaseFactor: Double  // Multiplier to convert this unit to the SI base unit
)
...
object UnitCatalog {
    ...
    /**
     * Converts [value] from [from] to [to] within the same category.
     * Algorithm: value → SI base unit → target unit.
     */
