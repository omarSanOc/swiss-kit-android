...
data class FinanceUiState(
    ...
    val selectedCategories: Set<String> = setOf(FinanceCategorySelectionEngine.KEY_ALL),
    ...
    val isFiltered: Boolean get() = searchQuery.isNotBlank() || selectedCategories != setOf(FinanceCategorySelectionEngine.KEY_ALL)
